...
APP_ID=3638699 #my.telegram.org
...
def staat(qq):
  ...
  data = {
    "chat_id": str(qq),
    "photo": "https://telegra.ph/file/019c64c87c4ceef328e42.jpg",
    "caption": "ශ්‍රී ලංකාවේ කොරෝනා තතු එසැනින් දැනගන්න. @CeylonTech_Official Group එකට Add කරගත් පසු ස්වයංක්‍රියව නවතම කොරෝනා තතු ලබාගත හැක.  වැඩි විස්තර සදහා /help භාවිතා කරන්න.     ෴ @percy_jackson_4 ",
    "parse_mode": "HTML",
    "reply_markup": {
        "inline_keyboard": [
            [
                {
                    ...
                    "url": "https://t.me/@ovid19_tracker_ctbot?startgroup=new"
                }, 
                {
                    "text": "🔊 Channel",
                    "url": "https://t.me/CeylonTech_plus"
                }
            ]
        ]
    }
